  ...
  return (
    <div className="border-b border-slate-200 dark:border-slate-700 py-4">
      ...
      >
        ...
        <div className="flex-shrink-0 w-8 h-8 rounded-full border border-slate-300 dark:border-slate-600 flex items-center justify-center text-slate-500 dark:text-slate-400">
          {isOpen ? (
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans text-slate-800 dark:text-slate-200 bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 dark:border-slate-700 min-h-[500px]">
              ...
              {activeTab === "OVERVIEW" ? (
                ...
                >
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-6 text-lg">
                    ...
                    exams and globally recognized grades. It is specially
                    designed to support students in excelling in their school
                    syllabus, including CBSE, ICSE, and other boards, ensuring
                    better academic performance and confidence in classroom
                    participation.
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    ...
                    language. Regular practice worksheets, school-oriented
                    assignments, and exam-focused revisions help students stay
                    ahead in their class and perform well in tests and oral
                    assessments.
                  </p>
                </motion.div>
              ) : (
      ...
      <section
        id="batches"
        className="py-16 bg-white dark:bg-slate-950 scroll-mt-24"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-50 dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col lg:flex-row gap-12 items-center">
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-8">
                ...
                <strong>Online Live Interactive</strong> Sessions. We have two
                types of Batches -{" "}
                <strong>Evening Batches & Weekend Batches</strong> to perfectly
                fit your child's school schedule.
              </p>
              <div className="space-y-4">
                {upcomingBatches.map((batch, idx) => (
                  <div
                    key={idx}
                    className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700"
                  >
              ...
              <div className="mt-8">
                <a
                  href="#contact"
                  className="px-8 py-3 rounded-full bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 font-semibold inline-flex items-center gap-2 hover:bg-slate-800 dark:hover:bg-white transition-colors"
                >
            ...
            <div className="w-full lg:w-1/2 relative">
              <div className="aspect-video rounded-3xl overflow-hidden shadow-2xl bg-slate-200 relative">
                <img
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                  <button className="w-16 h-16 bg-white/30 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-white text-white hover:bg-white/50 transition">
      ...
      <section
        id="coursedetails"
        className="py-12 bg-white dark:bg-slate-950 scroll-mt-24 border-t border-slate-100 dark:border-slate-800"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap sm:flex-nowrap gap-2 sm:gap-0 bg-white dark:bg-slate-700 p-1 rounded-full shadow-sm border border-slate-200 dark:border-slate-600 overflow-x-auto">
              {["Beginner", "Intermediate", "Advanced"].map((tab) => (
                <button
                  ...
                  className={`px-5 sm:px-8 py-2.5 rounded-full font-bold text-sm whitespace-nowrap transition-all duration-300 ${
                    pricingTab === tab
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 dark:text-white">
            Meet Your <span className="text-rose-500">Expert Teachers</span>
          </h2>
          ...
          <div className="relative group bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl rounded-3xl p-6 md:p-10 shadow-xl border border-white/30 dark:border-slate-700 transition-all duration-500 hover:shadow-2xl">
            ...
            <div className="relative flex flex-col md:flex-row items-center gap-10">
              <div className="relative">
                ...
                <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-rose-500 text-white text-xs px-3 py-1 rounded-full shadow-md whitespace-nowrap">
                  Goethe C2 Certified
                </div>
              </div>
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-rose-500 font-medium mb-4">
                  Top faculty pool specialized in School-Level German
                </p>
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
                  Sarah and our team of 100+ passionate German language teachers
                  are dedicated to helping school students discover the joy of
                  speaking a new language. Holding Goethe C2 certifications,
                  they have successfully guided thousands of young learners to
                  fluency and high exam grades.
                </p>
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  Our teaching focuses on confidence, creativity, and real-life
                  communication tailored for classes 5 to 12. For us, language
                  is not just grammar — it is expression, connection, and joy.
                </p>
                <a
                  href="#contact"
                  className="inline-block mt-6 px-6 py-2.5 rounded-full bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold shadow-md hover:shadow-lg hover:scale-105 transition"
                >
                  Talk to Faculty →
                </a>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((test, idx) => (
              <div
                key={idx}
                className={`${test.color} dark:bg-slate-800 p-8 rounded-3xl relative hover:scale-105 transition-transform duration-300 shadow-sm`}
              >
      ...
      {/* REDESIGNED CONTACT US (LEAD FORM) */}
      <section
        id="contact"
        className="relative py-24 bg-gradient-to-br from-rose-50 via-purple-50 to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden scroll-mt-24 border-t border-slate-100 dark:border-slate-800"
      >
        {/* Playful Background Blobs */}
        <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-rose-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 dark:opacity-10 animate-blob"></div>
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 dark:opacity-10 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-32 left-1/3 w-[400px] h-[400px] bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 dark:opacity-10 animate-blob animation-delay-4000"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            {/* Text Side */}
            <div>
              <p className="text-rose-600 dark:text-rose-400 font-bold mb-4 text-sm tracking-wider uppercase flex items-center gap-2">
                <Sparkles className="w-4 h-4" /> Invest in their future
              </p>
              ...
              <p className="text-slate-700 dark:text-slate-300 mb-8 text-lg leading-relaxed">
                Choosing the right mentor at the beginning of your child's
                language preparation can define their academic profile. We focus
                on building concepts, confidence, and fluency from day one.
              </p>
              <ul className="space-y-5 text-base text-slate-700 dark:text-slate-300 mb-10">
                <li className="flex items-center gap-4">
                  <div className="bg-rose-100 text-rose-500 rounded-full p-1.5 shadow-sm">
                    <CheckCircle2 className="w-5 h-5" />
                  </div>
                  Concept-driven teaching mapped to school syllabus (CBSE/ICSE)
                </li>
                <li className="flex items-center gap-4">
                  <div className="bg-purple-100 text-purple-600 rounded-full p-1.5 shadow-sm">
                    <Award className="w-5 h-5" />
                  </div>
                  Official Goethe-Zertifikat exam-oriented strategy
                </li>
                <li className="flex items-center gap-4">
                  <div className="bg-blue-100 text-blue-600 rounded-full p-1.5 shadow-sm">
                    <GraduationCap className="w-5 h-5" />
                  </div>
                  Structured study plans with continuous performance tracking
                </li>
              </ul>
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">
                Fill out the form and our academic counsellor will connect with
                you personally to guide your child's roadmap.
              </p>
            </div>

            {/* Glassmorphic Form Side */}
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-white/50 dark:border-slate-700 relative">
              {/* Floating Badges */}
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 flex gap-4">
                <div className="w-14 h-14 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center shadow-lg border border-slate-100 dark:border-slate-700 rotate-[-10deg] hover:rotate-0 transition-transform">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-center mt-8 mb-8 text-slate-900 dark:text-white">
                Get Expert Guidance
              </h3>
              ...
              <form className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-5 py-4 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-shadow shadow-sm"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label className="sr-only">
                    Tell Us About Your Child's Grade and Requirements
                  </label>
                  <textarea
                    rows="4"
                    placeholder="Tell Us About Your Child's Grade and Requirements"
                    className="w-full px-5 py-4 rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-shadow shadow-sm resize-none"
                  ></textarea>
                </div>

                <button
                  type="button"
                  className="w-full py-4 mt-2 rounded-full bg-gradient-to-r from-purple-600 to-rose-500 text-white font-bold text-lg hover:shadow-lg hover:shadow-purple-500/30 hover:scale-[1.02] transition-all duration-300"
                >
                  Submit Request
                </button>
              </form>
